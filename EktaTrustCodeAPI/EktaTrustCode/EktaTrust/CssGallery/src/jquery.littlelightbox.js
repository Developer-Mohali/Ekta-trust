 ...
 ;(function(win, doc, $, undefined) {
 	...
 	$.extend(lightbox, {
 		defaults: {
 				...
 				// Open Animate.
 				openMethod: 'elasticIn', // including 'changeIn','fadeIn', 'elasticIn'
 				openDirect: 'changeIn', // Avaliable if openMethod is 'changeIn', 'down', 'up', 'left', 'right' is avaliable.
 				openSpeed: 400,
