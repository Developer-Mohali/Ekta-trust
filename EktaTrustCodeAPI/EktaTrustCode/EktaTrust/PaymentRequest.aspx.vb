...
Public Class PaymentRequest
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lblExpiryDate.Text = expiryMonth + "/" + expiryYear
            ...
            transactionData.Add("TxnRefNo", System.Configuration.ConfigurationManager.AppSettings("TxnRefNo"))
            ...
            transactionData.Add("ExpiryDate", expiryMonth + "/" + expiryYear)
    ...
    Private Sub LoadUser()
        ...
        Using con As New MySqlConnection(constr)
            con.Open()
            Dim email As String = CStr((Session("Email")))
            Dim name As String = CStr((Session("Name")))
            Dim shirtsize As String = CStr((Session("ShirtSize")))

            Using cmd As New MySqlCommand("select * from registration where EmailID='" & email & "' and Name='" & name & "' and ShirtSize='" & shirtsize & "'", con)
