<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="NewsGallery.aspx.vb" Inherits="EktaTrust.NewsGallery" %>
            ...
            <div class="jquery-script-ads" style="margin: 6px auto;">
             ...
             <div class="col-md-3 col-sm-2 col-xs-12" style="padding-right: 0px;padding-left: 0px; top: 10px;">
                 ...
                 <div class="panel-group" id="accordionGallery">
                            ...
                            <%--<div class="panel panel-default">
                                <div class="panel-heading">
                                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordionGallery" href="#collapseTwo1" style="font-size: 14px">
                 ...
                 <a href="../Dandawas" class="list-group-item active">Donation to Dangawas Atrocity Victims</a>
            ...
            <div class="col-md-9 col-sm-10 col-xs-12" style="padding-right: 0px; padding-left: 0px; top: 10px;">
                ...
                <div class="row marginImage" style="margin-left: 15px">
                    <div id="box" class="burst-side strawberry">
                        ...
                        <img class="thumbnail" id="dd" src="Images/Image-1.png?image=1" alt="" />
                        <div>
                            <a class="lightbox" href="Images/Image-1.png?image=1" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Images/Image-2.png?image=2" alt="#" />
                        <div>
                            <a class="lightbox" href="Images/Image-2.png?image=2" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Images/Image-3.png?image=3" />
                        <div>
                            <a class="lightbox" href="Images/Image-3.png?image=3" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Images/Image-4.jpg?image=4" alt="#" />
                        <div>
                            <a class="lightbox" href="Images/Image-4.jpg?image=4" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        ...
                        <img class="thumbnail" id="dd" src="Images/Image-5.png?image=5" alt="#" />
                        <div>
                            <a class="lightbox" href="Images/Image-5.png?image=5" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <%-- <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="EktaTrustImage/Image-6.png?image=6" alt="#" />
                    <div>
