    ...
    <section class="page">
        ...
        <div class="container">
            ...
            <div class="col-md-3 col-sm-2 col-xs-12" style="padding-right: 0px; padding-left: 0px; top: 10px;">
                ...
                <a href="../Una" class="list-group-item active">Donation to Una Atrocity Victims</a>
            ...
            <div class="col-md-9 col-sm-10 col-xs-12" style="padding-right: 0px; padding-left: 0px; top: 10px;">
                ...
                <div class="row marginImage" style="margin-left: 15px">
                    <div id="box" class="burst-side strawberry">
                        ...
                        <img class="thumbnail" id="dd" src="UnaGallery/Image-1.png?image=1" alt="" />
                        <div>
                            <a class="lightbox" href="UnaGallery/Image-1.png?image=1" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="UnaGallery/Image-2.png?image=2" alt="#" />
                        <div>
                            <a class="lightbox" href="UnaGallery/Image-2.png?image=2" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="UnaGallery/Image-3.png?image=3" />
                        <div>
                            <a class="lightbox" href="UnaGallery/Image-3.png?image=3" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="UnaGallery/Image-4.png?image=4" alt="#" />
                        <div>
                            <a class="lightbox" href="UnaGallery/Image-4.png?image=4" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        ...
                        <img class="thumbnail" id="dd" src="UnaGallery/Image-5.png?image=5" alt="#" />
                        <div>
                            <a class="lightbox" href="UnaGallery/Image-5.png?image=5" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="UnaGallery/Image-6.png?image=6" alt="#" />
                        <div>
                            <a class="lightbox" href="UnaGallery/Image-6.png?image=6" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
