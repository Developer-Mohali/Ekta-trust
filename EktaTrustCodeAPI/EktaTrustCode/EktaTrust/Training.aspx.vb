...
Public Class Training
    ...
    Protected Sub ButtonSubmitMessage_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Using con As New MySqlConnection(constr)
            Using cmd As New MySqlCommand("Insert_Training")
                Using sda As New MySqlDataAdapter()
                    ...
                    Try
                        ...
                        Msg.Body = (("Sender Name: " + textName.Text & "<br><br>Sender Email: ") + textEmail.Text & "<br><br>") + ddlTraining.SelectedItem.Value + textMobile.Text
