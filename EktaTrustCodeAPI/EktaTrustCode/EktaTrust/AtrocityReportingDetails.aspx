<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Inner.Master" CodeBehind="AtrocityReportingDetails.aspx.vb" Inherits="EktaTrust.AtrocityReportingDetails" %>
    ...
    <div class="container-fluid main-container">
                    ...
                    <nav class="navbar navbar-default" role="navigation">
                        ...
                        <div class="side-menu-container">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="AtrocityReportingDetails.aspx">Atrocities Reporting Details</a></li>
        ...
        <div class="col-md-10 ">
            <div class="table-responsive">
                ...
                <!---- Atrocities Reportin panel ---->
                <asp:Panel ID="matrimonialPanel" runat="server">

                    <h2 class="admin-heading">Atrocities Reporting Details</h2>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnShowRequest" runat="server" Text="Request For Account Delete" disabled="disabled"/>
                                </td>
                            </tr>
                        </tbody>
                        <asp:GridView ID="gvEvent" runat="server" class="table table-bordered table-hover table-striped" AutoGenerateColumns="false" DataKeyNames="Id" PageSize="25"
                            EmptyDataText="No records has been added." OnRowDataBound="gvEvent_RowDataBound1" Style="font-weight: normal;" OnRowDeleting="Atrocity_RowDeleting" OnPageIndexChanging="gvEvent_PageIndexChanging">
                            <Columns>
                                <asp:BoundField HeaderText="Reporter Name" DataField="ReporterName" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
                                <asp:BoundField HeaderText="Reporter Email" DataField="ReporterEmail" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
                                <asp:BoundField HeaderText="Reproter Phone" DataField="ReporterPhone" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
                                <asp:BoundField HeaderText="Details" DataField="Details" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
                                <asp:BoundField HeaderText="Victims Name" DataField="VictimsName" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
                                <asp:BoundField HeaderText="Victims Phone" DataField="VictimsMobile" ItemStyle-HorizontalAlign="Left"></asp:BoundField>                 
                ...
                <asp:Panel ID="requestpanel" runat="server">
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <asp:TextBox ID="txtSearchRequest" runat="server"></asp:TextBox>
                                ...
                                <td>
                                    <asp:Button ID="btnSearchRequest" runat="server" Text="Search"  />
                                </td>
                                <td>
                                    <asp:Button ID="btnMatrimonialAll" runat="server" Text="Matrimonial Details" />
                                </td>
                            </tr>
                        </tbody>
                            ...
                            <div class="modal-header">
                                <div style="border-bottom: 1px solid #e5e5e5;">
                                    ...
                                    <tr style="background-color: #D55500">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <h4>Atrocity Reporting Details</h4>
                                            </div>
                                            <div class="col-sm-3">
                                                <h4>Date of Reporting:</h4>
                                            </div>
                                ...
                                <div class="modal-body" style="width: 780px; overflow-y: auto">
                                    <table class="col-sm-12 table-hover box divDisgn">
                                        ...
                                        <tr class="trBack">
                                            <td class="tdHeads" colspan="3">Reporter's  Information
                                            </td>
                                            <td class="tdstyle">&nbsp;
                                            </td>
                                        </tr>
                                        ...
                                        <tr style="border: none">
                                            ...
                                            <td class="col-sm-3">
                                                <b>:</b>&nbsp;&nbsp;<asp:Label ID="reporterName" CssClass="labelCapital" runat="server" Text="Label"></asp:Label>
                                            </td>
                                           <td class="col-sm-3">
                                                <asp:Label CssClass="labelfont" runat="server" Text="Label">Mobile No</asp:Label>
                                            </td>
                                            <td class="col-sm-3">
                                                <b>:</b>&nbsp;&nbsp;<asp:Label ID="reporterPhone" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>                                            
                                            <td class="col-sm-3">
                                            ...
                                            <td class="col-sm-3">
                                                <b>:</b>&nbsp;&nbsp;<asp:Label ID="reporterEmail" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>   
                                        ...
                                        <!------Victim Information------------->
                                        <tr class="trBack">
                                            <td class="tdHeads" colspan="3">Victim's Information
                                            </td>
                                            <td class="tdstyle">&nbsp;
                                            </td>
                                        </tr>
                                        <tr>
                                         ...
                                         <tr style="border: none">
                                            ...
                                            <td class="col-sm-3">
                                                <b>:</b>&nbsp;&nbsp;<asp:Label ID="victimsName" CssClass="labelCapital" runat="server" Text="Label"></asp:Label>
                                            </td>
                                           <td class="col-sm-3">
                                                <asp:Label CssClass="labelfont" runat="server" Text="Label">Place</asp:Label>
                                            </td>
                                            <td class="col-sm-3">
                                                <b>:</b>&nbsp;&nbsp;<asp:Label ID="place" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>    
                                            <td class="col-sm-3">
                                            ...
                                            <td class="col-sm-3">
                                                <b>:</b>&nbsp;&nbsp;<asp:Label ID="victimsMobile" runat="server" Text="Label"></asp:Label>
                                            </td>                                          
                                        </tr>  
                                        <tr>
                                            <td class="col-sm-3">
                                                <asp:Label CssClass="labelfont" runat="server" Text="Label">Details</asp:Label>
                                            </td>
                                            <td colspan="3" class="col-sm-3">
                                                <b>:</b>&nbsp;&nbsp;<asp:Label ID="details" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
