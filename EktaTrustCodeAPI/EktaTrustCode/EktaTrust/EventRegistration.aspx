    ...
    <div class="clsBackImage">
        ...
        <div>
            ...
            <div id="PaymentTab" class="col-sm-8">
                <fieldset id="basic_information">
                    ...
                    <h3 class="fs-subtitle">Please Provide your basic Information.   <span class="pull-right" style="color:red"><b> Event Date -</b> 14th April 2017<br /> <b>Venue -</b> Ambedkar Circle, Jaipur*</span></h3>
                    ...
                    <div class="form-group col-sm-12">
                        <asp:DropDownList runat="server" class="form-control" ID="drpEvent">
                            <asp:ListItem Value="2" Selected="True">Ambedkar Run For Equality 10 KM</asp:ListItem>
                            <asp:ListItem Value="3">Ambedkar Run For Equality 5 KM</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="form-group col-sm-12">
                        <div>
                            <input type="text" class="form-control" id="address" rows="3" columns="40" id="address" name="address" placeholder="Enter Address" />
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div>
                            ...
                            <input type="button" name="next" id="NextSubmit" class="next action-button" value="Next" />
                        </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('#submitEventDetail').click(function () {
