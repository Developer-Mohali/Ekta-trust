<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Inner.Master" CodeBehind="MigrantsRegistrationDetails.aspx.vb" Inherits="EktaTrust.MigrantsRegistrationDetails" %>
...
.width{
    ...
    <div class="row"> 
        ...
        <nav class="navbar navbar-default" role="navigation"> 
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="MIPFacultyRegistrationDetails.aspx">MIP Faculty Registration Details</a></li>
                ...
                <li><a href="MigrantsRegistrationDetails.aspx">Migrants Registration Details</a></li>
    ...
    <div class="col-md-10 ">
        <h2 class="admin-heading">Migrants Registration Details</h2>
...
<asp:Button ID="Button1" runat="server" Text="Export to Excel"  OnClick="Button1_Click" class="btn btn-info"
 ...
 <br/>
            ...
            <asp:GridView ID="gvEvent" runat="server" class="table table-bordered table-hover table-striped" AutoGenerateColumns="false" DataKeyNames="MigrantsId"  PageSize="25" 
...
<Columns> 
    ...
    <asp:BoundField HeaderText="AdharCardNumber" DataField="AdharCardNumber" ItemStyle-HorizontalAlign="Left"></asp:BoundField>   
    <asp:BoundField HeaderText="Mobile Number" DataField="MobileNumber" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
    <asp:BoundField HeaderText="PresentAddress" DataField="PresentAddress" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
    <asp:BoundField HeaderText="NativeAddress" DataField="NativeAddress" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
    <asp:BoundField HeaderText="CreatedDate" DataField="CreatedDate" ItemStyle-HorizontalAlign="Left"></asp:BoundField> 
...
<h4>Migrants Registration Details</h4>
 </div>    
...
<div class="form-group">
<asp:Button ID="btnUpdate" CommandName="Update" runat="server" class="btn btn-primary btn-lg"  Text="Update"/>
