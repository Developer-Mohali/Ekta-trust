...
Public Class LogIn
    ...
    Protected Sub ButtonSignIn_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Using con As New MySqlConnection(constr)
            Using cmd As New MySqlCommand("select  EmailAddress, RoleId, UserId, Password, TwoFAEnabled, TwoFASecret from signup where EmailAddress =@EmailAddress and Password=@Password ", con)
                ...
                ElseIf dt.Rows.Count = 0 Then
                    Using cmds As New MySqlCommand("select EmailAddress, RoleId, ID, Password, TwoFAEnabled, TwoFASecret from User where EmailAddress=@EmailAddress and Password=@Password ", con)
