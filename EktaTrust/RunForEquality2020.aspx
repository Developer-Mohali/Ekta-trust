<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="RunForEquality2020.aspx.vb" Inherits="EktaTrust.RunForEquality20201" %>
            ...
            <div class="col-md-3 col-sm-2 col-xs-12" style="padding-right: 0px; padding-left: 0px; top: 10px;">
                ...
                <div class="panel-group" id="accordionGallery">
                        ...
                        <div id="collapseThree2" class="panel-collapse in" style="height: auto;">
                            ...
                            <a href="../RunForEquality2020.aspx" class="list-group-item active">Run For Equality 2020</a>
            ...
            <div class="col-md-9 col-sm-10 col-xs-12" style="padding-right: 0px; padding-left: 0px; top: 10px;">
                ...
                <div class="row marginImage" style="margin-left: 15px">
                    <div id="box" class="burst-side strawberry">
                        ...
                        <img class="thumbnail" id="dd" src="Gallery_2020/march2.jpg" alt="#" />
                        <div>
                            <a class="lightbox" href="Gallery_2020/march2.jpg" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        ...
                        <img class="thumbnail" id="dd" src="Gallery_2020/march3.jpg" alt=" " />
                        <div>
                            <a class="lightbox" href="Gallery_2020/march3.jpg" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
