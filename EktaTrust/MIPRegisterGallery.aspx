<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="MIPRegisterGallery.aspx.vb" Inherits="EktaTrust.NewsGallery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="page">
        ...
        <div class="container">
                ...
                <p class="gallery">MIP RPSC Gallery 2017
             ...
             <div class="row marginImage" style="margin-left: 15px">
              ...
              <div class="col-md-3 col-sm-2 col-xs-12" style="padding-right: 0px;padding-left: 0px; top: 10px;">
                 ...
                 <div class="panel-group" id="accordionGallery">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="Mip" class="panel-collapse in" style="height: auto;">
                                    ...
                                    <a href="../MIP" class="list-group-item active">RPSC Aug-Sep 2017</a>
                 ...
                 <a href="../MIP" class="list-group-item active">Mock Interview Programme (MIP) RPSC Aug-Sep 2107</a>--%>

                 <a href="../VolleyBall.aspx" class="list-group-item">Mata Ramabai Ekta Vollyball cup 2017</a>
            ...
            <div class="row marginImage" style="margin-left: 15px">
              ...
              <%-- <div id="box" class="burst-side strawberry">
               ...
               <%-- <div id="box" class="burst-side strawberry">
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp1.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp1.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp2.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp2.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp3.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp3.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp4.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp4.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp5.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp5.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp6.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp6.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp7.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp7.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp8.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp8.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp9.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp9.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp10.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp10.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp11.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp11.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp12.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp12.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp13.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp13.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp14.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp14.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/whatsapp15.png?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/whatsapp15.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="MIPGallery/RAS MIP.jpg?image=14" alt="" />
                    <div>
                        <a class="lightbox" href="MIPGallery/RAS MIP.jpg?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
          ...
          <%--  <div class="row marginImage" style="margin-top: 6px; margin-left: 15px">
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="EktaTrustImage/Image-8.png?image=8" alt="#" />
                    <div>
                        <a class="lightbox" href="EktaTrustImage/Image-8.png?image=8" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
            ...
            <div class="row marginImage" style="margin-top: 6px; margin-left: 15px">
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="EktaTrustImage/Image-14.png?image=14" alt="#" />
                    <div>
                        <a class="lightbox" href="EktaTrustImage/Image-14.png?image=14" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="EktaTrustImage/Image-17.png?image=17" alt="#" />
                    <div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="EktaTrustImage/Image-18.png?image=18" alt="#" />
                    <div>
