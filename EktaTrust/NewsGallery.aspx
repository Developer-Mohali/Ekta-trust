        ...
        <div class="container">
            ...
            <div class="row marginImage" style="margin-left: 15px">
                <div id="box" class="burst-side strawberry">
                    ...
                    <img class="thumbnail" id="dd" src="Images/Image-5.png?image=1" alt="" />
                    <div>
                        <a class="lightbox" href="Images/Image-5.png?image=1" data-littlelightbox-group="gallery" title="<b>DANGAWAS VICTIMS NEWS<b/> <br>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain. These cases are perfectly simple and easy to distinguish. In a free hour, when our power of choice is untrammelled and when nothing prevents our being able to do what we like best, every pleasure is to be welcomed and every pain avoided.">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="Images/Image-3.png?image=3" alt="#" />
                    <div>
                        <a class="lightbox" href="Images/Image-3.png?image=3" data-littlelightbox-group="gallery" title="<b>DANGAWAS VICTIMS NEWS<b/> <br>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain. These cases are perfectly simple and easy to distinguish. In a free hour, when our power of choice is untrammelled and when nothing prevents our being able to do what we like best, every pleasure is to be welcomed and every pain avoided.">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="Images/Image-3.png?image=3" alt="Love nature as if love myself" />
                    <div>
                ...
                <div id="box" class="burst-side strawberry">
                    <div class="caption"></div>
                    <img class="thumbnail" id="dd" src="Images/Picture4.png?image=4" alt="#" />
                    <div>
                        <a class="lightbox" href="Images/Picture1.png?image=4" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                <div id="box" class="burst-side strawberry">
                    ...
                    <img class="thumbnail" id="dd" src="Images/Image-5.jpg?image=5" alt="#" />
                    <div>
                        <a class="lightbox" href="Images/Image-5.jpg?image=5" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
