<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="EktaCreativeCompetitionGallery2025.aspx.vb" Inherits="EktaTrust.EktaCreativeCompetitionGallery2025" %>
            ...
            <div class="col-md-9 col-sm-10 col-xs-12" style="padding-right: 0px; padding-left: 0px; top: 10px;">
                ...
                <div class="row marginImage" style="margin-left: 15px">
                    <div id="box" class="burst-side strawberry">
                        ...
                        <img class="thumbnail" id="dd" src="CreativeCompetitionGallery2023/1-2025.jpeg" alt="#" />
                        <div>
                            <a class="lightbox" href="CreativeCompetitionGallery2023/1-2025.jpeg" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
