<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="UpscMipGallery2025.aspx.vb" Inherits="EktaTrust.UpscMipGallery2025" %>
            ...
            <div class="col-md-9 col-sm-10 col-xs-12" style="padding-right: 0px; padding-left: 0px; top: 10px;">
                ...
                <div class="row marginImage" style="margin-left: 15px">
                    <div id="box" class="burst-side strawberry">
                        ...
                        <img class="thumbnail" id="dd" src="Gallery_2025/Img4.png" alt="#" />
                        <div>
                            <a class="lightbox" href="Gallery_2025/Img4.png" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                    ...
                    <div id="box" class="burst-side strawberry">
                        ...
                        <img class="thumbnail" id="dd" src="Gallery_2025/Img5.png" alt="#" />
                        <div>
                            <a class="lightbox" href="Gallery_2025/Img5.png" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
