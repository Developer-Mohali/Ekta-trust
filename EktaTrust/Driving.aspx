<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="Driving.aspx.vb" Inherits="EktaTrust.Driving" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="container">
     ...
     <img src="images/driving_img.jpg"  class="img-responsive img-rounded  wow fadeInDown" alt="">
    <h2 class="wow fadeInDown">Driving</h2>
