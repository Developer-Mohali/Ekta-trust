<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CertificationReport.aspx.vb"  MasterPageFile="~/MasterPage/Inner.Master" Inherits="EktaTrust.CertificationReport" %>
...
#certificateFileUpload{
    ...
    <div class="row"> 
        ...
        <nav class="navbar navbar-default" role="navigation"> 
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="CertificationReport.aspx">Certification</a></li>
    ...
    <div class="col-md-10 ">
        <h2 class="admin-heading">Certification</h2>
    ...
    <div class="table-responsive">
       <asp:Label ID="MessageUpdated" runat="server" Text="" ForeColor="Green"></asp:Label>
        ...
        <td> Upload CSV file
           <asp:FileUpload ID="certificateFileUpload" style="display:inline-block;margin-left: 12px;" runat="server" />
        </td><td>
...
<Columns> 
    ...
    <asp:BoundField HeaderText="Bib No" DataField="bib_no" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
    <asp:BoundField HeaderText="Event Name" DataField="event_name" ItemStyle-HorizontalAlign="Left"></asp:BoundField>  
    <asp:BoundField HeaderText="Participate Name" DataField="participate_name" ItemStyle-HorizontalAlign="Left"></asp:BoundField>   
    ...
    <asp:BoundField HeaderText="Phone" DataField="phone" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
    <asp:BoundField HeaderText="Year" DataField="year" ItemStyle-HorizontalAlign="Left"></asp:BoundField> 
    <asp:BoundField HeaderText="Start Time" DataField="start_time" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
    <asp:BoundField HeaderText="Overall Place" DataField="overall_pace" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
    <asp:BoundField HeaderText="Category Rank" DataField="category_rank" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
