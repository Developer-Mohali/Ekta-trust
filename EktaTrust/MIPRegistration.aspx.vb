...
Public Class MIPRegistration
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If masterlbl = "RPSC" Then
            lblTitle.Text = "THE RAJASTHAN STATE & SUBORDINATE SERVICES COMBINED COMPETITIVE (MAINS) EXAMINATION, 2022."
            divTermscondition.Visible = False
            chbCondition.Checked = True
        Else
            'lblTitle.Text = "MOCK INTERVIEW PROGRAMME (MIP) - Registration for CSE-2022 Qualified Candidates"
            lblTitle.Text = "FREE IAS Mock Interview Programme (MIP) - Registration for CSE-2024 Qualified Candidates."
