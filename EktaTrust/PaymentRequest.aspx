                        ...
                        <div>
                            <div class="social col-sm-3 pull-right">
                                <ul class="social-share ">
                                     <li><a href="https://t.me/EktaTrust" target="_blank"><i class="fab fa-telegram-plane"></i></a></li>
   ...
   <div class="form-group">
    ...
    <div class="row ">
        <div class="col-sm-offset-4">
                                <table class="trustee-table divPanelChair " style="margin-left:-40px; width: 58%;">
...
<form name="RedirectForm" id="RedirectForm" runat="server" action="https://isgpay.com/ISGPay/request.action" method="post">
        ...
        <asp:Panel ID="Panel_Debug" runat="server" >
            ...
            <table>
                <tr>
                    <td>
                        <asp:Label ID="Label_Debug" runat="server" Visible="false" /></td>
                </tr>
                <tr>
                    <td>
        ...
        <table width="80%" align="center" border="0" cellpadding='0' cellspacing='0'>         
            ...
            <tr>
                ...
                <input type="submit" name="submit" value="Are you sure to Pay?" /></td>
            </tr>
        </table>
    </form>
</body>
