<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="HelpingNews.aspx.vb" Inherits="EktaTrust.HelpingNews" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="container">
    ...
    <img src="Images/img_3%20(1).png" class="img-responsive img-rounded  wow fadeInDown" alt=""></div>
   <div style="float:right"> <h2 class="wow fadeInDown">Helping News</h2>
