...
Public Class EventRegistration
    ...
    Public Shared Function SaveBibForm(amount As String, email As String, gender As String, name As String, phone As String, runCategory As String, runnerDOB As String, tshirtSize As String
        ...
        Try
            ...
            Using con As New MySqlConnection(constr)
                Using cmd As New MySqlCommand(insertQuery)
                    'Using cmd As New MySqlCommand("InsertBIBData")
                    Using sda As New MySqlDataAdapter()
                        cmd.Parameters.AddWithValue("@RunnerName", name)
                        cmd.Parameters.AddWithValue("@runCategory", runCategory)
                        cmd.Parameters.AddWithValue("@tshirtSize", tshirtSize)
                        cmd.Parameters.AddWithValue("@gender", gender)
                        cmd.Parameters.AddWithValue("@phone", phone)

                        cmd.Parameters.AddWithValue("@category", category)
                        cmd.Parameters.AddWithValue("@runnerDOB", runnerDOB)
