<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Inner.Master" EnableEventValidation="false" CodeBehind="MIPRegistrationDetails.aspx.vb" Inherits="EktaTrust.MIPRegistrationDetails" %>
...
.width{
    ...
    <div class="row"> 
        ...
        <nav class="navbar navbar-default" role="navigation"> 
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="MIPRegistrationDetails.aspx">MIP-Registration Details</a></li>
    ...
    <div class="col-md-10 ">
        <h2 class="admin-heading">MIP-Registration Details</h2>
    ...
    <tr><td>Search By:
        ...
        <td>Filter By Year
            <asp:DropDownList ID="DropDownList2" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" runat="server" AutoPostBack="True">
        <asp:ListItem Text="All"></asp:ListItem>
        ...
        <td>
             <asp:Button ID="Button1" runat="server" Text="Export to Excel" OnClick="Button1_Click1" class="btn btn-info"/>
        </td>
    </tr>
...
<Columns> 
    ...
    <asp:BoundField HeaderText="Roll No" DataField="RollNo" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
    ...
    <asp:BoundField HeaderText="Mobile Number" DataField="Mobile" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
     <asp:BoundField HeaderText="Upload File" DataField="UploadFile" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%"></asp:BoundField>
...
<h4>MIP Registration Details</h4>
 </div>    
...
<div class="form-group">
<label>Roll No: </label>
<asp:TextBox ID="RollNo" runat="server" class="form-control" style="width:95%"/>
</div>
...
<asp:TextBox ID="Email"    runat="server" class="form-control" style="width:95%"/>
        ...
        <div class="form-group">
<label>Mobile: </label>
<asp:TextBox ID="Mobile" Rows="2" Columns="10" TextMode="SingleLine"   runat="server" class="form-control" style="width:95%"/>
</div>
     <div class="form-group">
<label>Address: </label>
<asp:TextBox ID="Address" TextMode="MultiLine" Rows="6" Columns="10" runat="server" class="form-control" style="width:95%"/>
</div>
<div class="form-group">
