<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="TermsAndCondition.aspx.vb" Inherits="EktaTrust.TermsAndCondition" %>
    ...
    <div class="container">
        <div class="wow fadeInDown">
            <div class="bounceInLeft">
                <p style="font-size:30px; font-weight:bolder; text-align:center"><u>Terms And Conditions</u></p>
            </div>
<h2> For Event Activities</h2>
            <p>
                1. Your participation in any and all activities, facilities, programs, and services provided by Ekta Navnirman Trust is at your own risk and you assume full responsibility for your choice to use and/or apply the information or instruction you receive and assume any and all risk of injury, illness, damage, loss, or expense that might result.
            </p>
            <p>
...
<p>1. When you opt-in to the Short Message Service (SMS) using a short code by texting REG, we will send you an SMS text message to confirm your RIP 
    ...
    agreeing to the Terms and Conditions set forth. These Terms and Conditions may change from time to time.</p>
<p>2. You can cancel and opt-out of the SMS service at any time. Just text "STOP" to 47734 to stop. We will send you an SMS message to confirm that 
    you have been unsubscribed. After this, you will no longer receive SMS messages from us. If you want to join again, just text "REG" to short code 
    to register as you did the first time. We will start sending SMS messages to you again.</p>
<p>3. If, at any time, you forget what keywords are supported, just text "HELP"
to 47734 for help. We will respond with several keywords supported by our service: REG, NICK, OUT, STAT, PAUSE, RESUME, STOP, STOP ALL</p>
<p>4. We are able to deliver messages to the following major mobile phone carriers and most minor carriers and deliver only on Indians mobile numbers.</p>

<p>5. As always, Message & data rates may apply. One message per user request. If you have any questions about your text plan or data plan, it is best to
     contact your wireless provider. For general questions about the services provided by the short code, you can send an email to 
    <span style="color:blue"> ektanavnirmantrust@gmail.com.</span></p>
<p>6. If you have any questions regarding privacy, please read our privacy policy: 
    <a href="Home.aspx" style="color:blue" target="_blank"> http://ektatrust.org.in</a></p>

<h2>User Conduct</h2>
<p>You agree not to send or otherwise make available content that is unlawful, harmful, threatening, abusive, harassing, tortious, defamatory, vulgar, obscene, 
...
<p>When you visit our web site, some information may be collected automatically by the software that operates our website (e.g. the site from which you linked, your 
    Internet Service Provider, the time and date of your visit). Our servers do not track, collect, or distribute personal information about visitors to our web site. 
    This information is used to compile aggregate statistics about the total number of daily visitors to our site, the pages most frequently visited, how long people 
    stay at each page, etc. None of the information that we report allows for the personal identification of individuals.</p>
<h2>Security</h2>
<p>We use firewalls and additional measures to ensure the security of your personal information against loss, theft and unauthorized access.</p>
<h2>Cookies</h2>
<p>When you visit our website we use cookies. Cookies are small pieces of data, which are stored on your computer to allow your web browser to remember something about 
    our web site. However, no information that makes a user personally identifiable is retained in any cookie. Using cookies allows us to provide additional features 
    and functionality to our users.</p>
<h2>Accuracy of Your Information / Opting Out</h2>
<p>If you wish to have any of your personal information amended or removed from our computer systems, please contact us at <span style="color:blue"> ektanavnirmantrust@gmail.com.</span></p>
<h2>Links</h2>
<p>Our website may contain links to other web sites; however, we cannot be responsible for the privacy practices and policies of third-party websites.</p>
        </div>
    </div>
</div>
</asp:Content>
