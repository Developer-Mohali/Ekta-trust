<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="Gallery_2020.aspx.vb" Inherits="EktaTrust.Gallery_2020" %>
        ...
        <div class="container">
                ...
                <div class="panel-group" id="accordionGallery">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseThree1" class="panel-collapse show" style="height: auto;">
                            ...
                            <a href="../Gallery2020" class="list-group-item active">Felicitation Programme 2020</a>
            ...
            <div class="col-md-9 col-sm-10 col-xs-12" style="padding-right: 0px; padding-left: 0px; top: 10px;">
               ...
               <div id="box" class="burst-side strawberry">
                    ...
                    <img class="thumbnail" id="dd" src="Gallery_2020/6M0A8336.JPG" alt="#" />
                    <div>
                        <a class="lightbox" href="Gallery_2020/1.JPG" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                   <div id="box" class="burst-side strawberry">
                       <div class="caption"></div>
                       <img class="thumbnail" id="dd" src="Gallery_2020/1.JPG" alt="#" />
                       <div>
                           <a class="lightbox" href="Gallery_2020/1.JPG" data-littlelightbox-group="gallery">
                               <h1>View Image</h1>
                           </a>
               ...
               <div id="box" class="burst-side strawberry">
                    ...
                    <img class="thumbnail" id="dd" src="Gallery_2020/2.JPG" alt="#" />
                    <div>
                        <a class="lightbox" href="Gallery_2020/2.JPG" data-littlelightbox-group="gallery">
                            <h1>View Image</h1>
                        </a>
                    </div>
                </div>
                   ...
                   <div id="box" class="burst-side strawberry">
                      ...
                      <div id="box" class="burst-side strawberry">
                       ...
                       <img class="thumbnail" id="dd" src="Gallery_2020/2.JPG" alt="#" />
                       <div>
                           <a class="lightbox" href="Gallery_2020/3.JPG" data-littlelightbox-group="gallery">
                               <h1>View Image</h1>
                           </a>
                       </div>
               ...
               <div id="box" class="burst-side strawberry">
                   ...
                   <div id="box" class="burst-side strawberry">
                      ...
                      <div id="box" class="burst-side strawberry">
                       <div class="caption"></div>
                       <img class="thumbnail" id="dd" src="Gallery_2020/4.JPG" alt="#" />
                       <div>
                           <a class="lightbox" href="Gallery_2020/4.JPG" data-littlelightbox-group="gallery">
                               <h1>View Image</h1>
                           </a>
                       </div>
               ...
               <div id="box" class="burst-side strawberry">
                   ...
                   <div id="box" class="burst-side strawberry">
                       ...
                       <img class="thumbnail" id="dd" src="Gallery_2020/3.JPG" alt="#" />
                       <div>
                           <a class="lightbox" href="Gallery_2020/4.JPG" data-littlelightbox-group="gallery">
                               <h1>View Image</h1>
                           </a>
