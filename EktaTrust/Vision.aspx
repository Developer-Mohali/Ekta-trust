<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="Vision.aspx.vb" Inherits="EktaTrust.Vision" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="about-us">
        <div class="container">
            ...
            <img src="images/vision_img.jpg" class="img-responsive img-rounded" alt="">
            <h2>Vision</h2>

            <div class="row center">
                <div class="col-sm-12 center  wow fadeInDown">
                    <h3>Vision</h3>
                    <img src="images/vision_img.png" alt="" class="img-responsive">
                    <p class="lead">
                        Create a Casteless and Atrocity free society where people can live with
                        <br>
                        dignity and self respect and contribute in nation building
                    </p>
                </div>
