<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="Covid19.aspx.vb" Inherits="EktaTrust.Covid191" %>
    ...
    <section class="page">
        ...
        <div class="container">
            ...
            <div class="col-md-3 col-sm-2 col-xs-12" style="padding-right: 0px; padding-left: 0px; top: 10px;">
                ...
                <a href="../Covid-19" class="list-group-item active">Covid-19</a>
            ...
            <div class="col-md-9 col-sm-10 col-xs-12" style="padding-right: 0px; padding-left: 0px; top: 10px;">
                ...
                <div class="row marginImage" style="margin-left: 15px">
                     <div id="box" class="burst-side strawberry">
                        ...
                        <img class="thumbnail" id="dd" src="Images/1.jpg?image=1" alt="#" />
                        <div>
                            <a class="lightbox" href="Images/1.jpg?image=1" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Images/2.jpg?image=1" alt="#" />
                        <div>
                            <a class="lightbox" href="Images/2.jpg?image=1" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Images/3.jpg?image=1" alt="#" />
                        <div>
                            <a class="lightbox" href="Images/3.jpg?image=1" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Images/4.jpg?image=1" alt="#" />
                        <div>
                            <a class="lightbox" href="Images/4.jpg?image=1" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Images/5.jpg?image=1" alt="#" />
                        <div>
                            <a class="lightbox" href="Images/5.jpg?image=1" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Images/7.jpg?image=1" alt="#" />
                        <div>
                            <a class="lightbox" href="Images/7.jpg?image=1" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Images/8.jpg?image=1" alt="#" />
                        <div>
                            <a class="lightbox" href="Images/8.jpg?image=1" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Images/10.jpg?image=1" alt="#" />
                        <div>
                            <a class="lightbox" href="Images/10.jpg?image=1" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    ...
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Images/11.jpg?image=1" alt="#" />
                        <div>
                            <a class="lightbox" href="Images/11.jpg?image=1" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                   ...
                   <%-- <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="MiscellaneousGallery/Image-1.jpeg?image=1" alt="#" />
                        <div>
                            <a class="lightbox" href="MiscellaneousGallery/Image-1.jpeg?image=1" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>--%>
                ...
                <div class="row marginImage" style="margin-top: 6px; margin-left: 15px">
                  ...
                  <%--  <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="MiscellaneousGallery/Image-6.jpeg?image=6" alt="#" />
                        <div>
                            <a class="lightbox" href="MiscellaneousGallery/Image-6.jpeg?image=6" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>--%>
                   <%-- <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="MiscellaneousGallery/Image-7.jpg?image=7" alt="#" />
                        <span>Testing</span>
                        <div>
                            <a class="lightbox" href="MiscellaneousGallery/Image-7.jpg?image=7" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                     <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="MiscellaneousGallery/Image-8.jpeg?image=8" alt="#" />
                        <div>
                            <a class="lightbox" href="MiscellaneousGallery/Image-8.jpeg?image=8" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                     <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="MiscellaneousGallery/Image-9.jpg?image=9" alt="#" />
                        <div>
                            <a class="lightbox" href="MiscellaneousGallery/Image-9.jpg?image=9" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                     <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="MiscellaneousGallery/Image-10.jpeg?image=10" alt="#" />
                        <div>
                            <a class="lightbox" href="MiscellaneousGallery/Image-10.jpeg?image=10" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
