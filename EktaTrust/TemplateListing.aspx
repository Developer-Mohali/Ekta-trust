<%@ Page Title="" Language="vb" AutoEventWireup="false" ValidateRequest="false" MasterPageFile="~/MasterPage/Inner.Master" CodeBehind="TemplateListing.aspx.vb"  Inherits="EktaTrust.TemplateListing" %>
        ...
        <nav class="navbar navbar-default" role="navigation"> 
            ...
            <div class="side-menu-container">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="TemplateListing.aspx">Templates</a></li>
...
<br />
        ...
        <h2 class="admin-heading">Templates</h2>
    ...
    <tr><td>Search By:
        ...
        <asp:ListItem Text="TemplateType"></asp:ListItem>       
        ...
        <td>
            <a href="ModificationEmailAndSms.aspx" class="btn btn-default" style="height:29px;width:65px;cursor:pointer;background-color:buttonface">
                Add
                </a>
 ...
 <br/>
            ...
            <asp:GridView ID="gvTamplate" runat="server" class="table table-bordered table-hover table-striped" AutoGenerateColumns="false" DataKeyNames="id"  PageSize="25" 
   EmptyDataText="No records has been added." OnRowDataBound="gvTamplate_RowDataBound1" Style="font-weight: normal;" OnRowDeleting="gvTamplate_RowDeleting" OnPageIndexChanging="gvTamplate_PageIndexChanging">
<Columns> 
    
   <asp:BoundField HeaderText="Category" DataField="Category" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
    <asp:BoundField HeaderText="Subject" DataField="Title" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
   
    <asp:BoundField HeaderText="Message" DataField="Message" ItemStyle-HorizontalAlign="Left"></asp:BoundField>  
    <asp:BoundField HeaderText="Template Type" DataField="TemplateType" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
...
<asp:TextBox ID="txtTitle"  cols="40" Rows="6" runat="server" TextMode="SingleLine" class="form-control" style="width:95%"/>
</div>
<div class="form-group">
<label>Message: </label>
<asp:TextBox ID="txtMessage" cols="40" Rows="10" runat="server" TextMode="MultiLine" class="form-control" style="width:95%"/>
</div>
