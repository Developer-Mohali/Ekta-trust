    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Page.Request.Form("EncData").Length > 0 Then
                ...
                Dim rupee As String = null2unknown(If(transactionData("Amount") Is Nothing, "", transactionData("Amount").ToString()))
                Dim rup As String = Convert.ToInt32(rupee) / 100
                Label_Amount.Text = rup
        ...
        Catch ex As Exception
            ...
            If ex.StackTrace.Length > 0 Then
                ...
                Panel_StackTrace.Visible = False
                Label_MerchantID.Visible = False
                Label_MerchTxnRef.Visible = False
                Label_OrderInfo.Visible = False
            End If
