<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="Events.aspx.vb" Inherits="EktaTrust.Events" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="about-us">
        <div class="container">
            ...
            <img src="images/events_img.jpg" class="img-responsive img-rounded  wow fadeInDown" alt="">
            <h2 class="wow fadeInDown">Events</h2>

            <p>Keep updated about our events</p>

            <table class="events-list table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>Meeting of Ekta Team is scheduled on 16/4/2016 & 24/4/2016.
A step towards empowering the people & social reform.
                    </td>
                    <td class="event-venue hidden-xs"><i class="icon-map-marker"></i></td>
