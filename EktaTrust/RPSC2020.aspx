<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="RPSC2020.aspx.vb" Inherits="EktaTrust.RPSC2020" %>
                ...
                <div class="panel-group" id="accordionGallery">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="Mip" class="panel-collapse in" style="height: auto;">
                            ...
                            <a href="../RPSC2020" class="list-group-item active">RPSC 2020</a>                            
                        </div>
                    </div>
            ...
            <div class="col-md-9 col-sm-10 col-xs-12" style="padding-right: 0px; padding-left: 0px; top: 10px;">
                ...
                <div class="row marginImage" style="margin-left: 15px">
                    <div id="box" class="burst-side strawberry">
                        ...
                        <img class="thumbnail" id="dd" src="Gallery_2020/1.jpg?image=1" alt="" />
                        <div>
                            <a class="lightbox" href="Gallery_2020/1.jpg?image=1" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Gallery_2020/2.jpg?image=2" alt="" />
                        <div>
                            <a class="lightbox" href="Gallery_2020/2.jpg?image=2" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Gallery_2020/3.jpg?image=3" alt="" />
                        <div>
                            <a class="lightbox" href="Gallery_2020/3.jpg?image=3" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Gallery_2020/4.jpg?image=4" alt="" />
                        <div>
                            <a class="lightbox" href="Gallery_2020/4.jpg?image=4" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Gallery_2020/5.jpg?image=5" alt="" />
                        <div>
                            <a class="lightbox" href="Gallery_2020/5.jpg?image=5" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Gallery_2020/6.jpg?image=6" alt="" />
                        <div>
                            <a class="lightbox" href="Gallery_2020/6.jpg?image=6" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
                    <div id="box" class="burst-side strawberry">
                        <div class="caption"></div>
                        <img class="thumbnail" id="dd" src="Gallery_2020/7.jpg?image=7" alt="" />
                        <div>
                            <a class="lightbox" href="Gallery_2020/7.jpg?image=7" data-littlelightbox-group="gallery">
                                <h1>View Image</h1>
                            </a>
                        </div>
                    </div>
