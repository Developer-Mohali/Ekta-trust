<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Admin.Master" CodeBehind="Anual ReportDetail.aspx.vb" Inherits="EktaTrust.Anual_ReportDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="container">
    ...
    <img src="images/news1.jpg" class="img-responsive img-rounded  wow fadeInDown" alt=""></div>
    <div style="float:left"> <h2 class="wow fadeInDown">Anual Report</h2>
